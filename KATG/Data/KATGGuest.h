...
@class KATGImage, KATGShow;

extern NSString *const KATGGuestGuestIDAttributeName;

@interface KATGGuest : NSManagedObject
...
@interface KATGGuest (CoreDataGeneratedAccessors)

- (void)addShowsObject:(KATGShow *)value;
- (void)removeShowsObject:(KATGShow *)value;
