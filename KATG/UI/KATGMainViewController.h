...
@interface KATGMainViewController : KATGCollectionViewController <KATGScheduleItemTableViewCellDelegate, KATGLiveCellDelegate>

@property (weak, nonatomic, readonly) KATGTabBar *tabBar;
